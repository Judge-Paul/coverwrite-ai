...
export default function Home() {
    return (
        <div>
            <h1 className="text-center pt-16 text-5xl font-bold tracking-wide text-[#333333] dark:text-[#f2f2f2]">
                JobWriteAI
            </h1>
            ...
            <h2 className="text-center pt-16 text-3xl md:text-4xl text-[#666666] dark:text-[#d9d9d9] font-bold">
