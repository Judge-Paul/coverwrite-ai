...
export default function Footer() {
  return (
    <footer className="bg-gray-800 pt-10 pb-6">
      <div className="max-w-7xl mx-auto px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        >
          <div className="px-5 py-2">
            <Link to="#" className="text-base text-gray-500 hover:text-white">
              About
            </Link>
          </div>
        ...
        <div className="text-center mt-10">
          <Link
            ...
            className="mt-7 text-base text-gray-400"
          >
            Have a feature you want to add or noticed a bug?{" "}
            <span className="hover:text-gray-300">Create an Issue</span>
          </Link>
        </div>
